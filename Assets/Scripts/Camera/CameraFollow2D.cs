...
public class CameraFollow2D : MonoBehaviour
{
	...
	public float topBoundary = 0;					//	The highest the camera can go in the y direction
	public float bottomBoundary = 0;				//	The lowest the camera can go in the y direction
	public float rightBoundary = 0;					//	The furthest the camera can go in the x direction
	public float leftBoundary = 0;					//	The lowest the camera can go in the x direction
